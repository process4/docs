If you need to update already existing publication start Model Publisher extension and on the start page select __Update an existing publication(s) option__. 
